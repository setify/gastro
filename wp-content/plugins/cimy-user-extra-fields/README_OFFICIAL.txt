...
- Fixed postLabels for dropdown and dropdown-multi were not correctly showed in the welcome email
...
- Fixed Wordpress hidden fields' postLabels not translated
...
- Added WordPress 2.7.x support
  ...
  - Fixed textarea-rich buttons postLabels
